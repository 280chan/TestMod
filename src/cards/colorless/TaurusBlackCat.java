...
import powers.TaurusBlackCatPower;
...
public class TaurusBlackCat extends AbstractTestCard {
    public static final String ID = "TaurusBlackCat";
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new TaurusBlackCatPower(p, this.magicNumber), this.magicNumber));
    }
